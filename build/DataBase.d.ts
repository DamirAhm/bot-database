...
export declare class DataBase {
    ...
    addHomework({ classNameOrInstance, schoolName }: IClassData, lesson: string, content: ICreateHomework, studentVkId: number, expirationDate?: Date): Promise<mongoose.Types.ObjectId | null>;
