...
exports.deeplyAssignObjects = (objA, objB) => {
    ...
    for (const key of keys) {
        if (['[object Object]', '[object Map]'].includes(objA[key]?.toString()) &&
            ...
            if (objA[key] instanceof Map) {
                if (objB[key] instanceof Map) {
                    assignedProperty = exports.deeplyAssignObjects(Object.fromEntries(objA[key]), Object.fromEntries(objB[key]));
                }
                else {
                    assignedProperty = exports.deeplyAssignObjects(Object.fromEntries(objA[key]), objB[key]);
                }
                //@ts-ignore
                ...
                if (objB[key] instanceof Map) {
                    assignedProperty = exports.deeplyAssignObjects(objA[key], Object.fromEntries(objB[key]));
                }
                else {
